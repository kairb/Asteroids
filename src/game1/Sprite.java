...
public class Sprite {
	public static Image ASTEROID,BACKGROUND, EXPLODE, PLAYERSHIP2,SHIELD,SAUCER;
	static {
		try {
			ASTEROID = ImageManager.loadImage("asteroid");
			BACKGROUND = ImageManager.loadImage("background");
			EXPLODE = ImageManager.loadImage("explode");
			PLAYERSHIP2 = ImageManager.loadImage("playership3");
