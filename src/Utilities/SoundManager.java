...
public class SoundManager {
    ...
    public final static Clip gameOver = getClip("gameOver");
    public final static Clip saucer = getClip("saucer");
    public final static Clip levelup = getClip("levelup");
    public final static Clip gameStart = getClip("gameStart");



    public final static Clip[] clips = {bangLarge, bangMedium, bangSmall, beat1, beat2,
            extraShip, fire, saucerBig, saucerSmall, thrust, gameOver,saucer};
    ...
    public static void saucerSpawn(){play(saucer);}
